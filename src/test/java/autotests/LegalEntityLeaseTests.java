...
@Slf4j
public class LegalEntityLeaseTests extends DataProviders {
    ...
    public void changeDownPaymentPercentTest() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Find.findAndClick(LEGAL_ENTITY_RADIO_BUTTON);
    ...
    @Test(dataProvider = "legalEntityFinancialLeaseWithVAT", description = "Verify that monthly payment amount changes with " +
            "the values that are given to the calculator. Use percentage values for down payment and residual value inputs.", priority = 7)
    public void getLegalEntityFinancialLeaseWithPercentagesAndVATTest(double price, String VATPaymentTime, String downPaymentPercent,
        ...
        Find.clearAndFillField(PRICE_FIELD, String.valueOf(price));
        LeasePage.changeVATPaymentSchedule(VATPaymentTime);
    ...
    public void getLegalEntityFinancialLeaseWithEurosAndVATTest(double price, String VATPaymentTime, String downPaymentPercentage,
                                                                  String leasePeriodYears, String leasePeriodMonths, String interest,
    ...
    @Test(description = "Verify that User can turn VAT included off on legal entity financial lease.", priority = 9)
    public void toggleVATIncludedOffForLegalEntityFinancialLeaseTest() {
    ...
    public void getLegalEntityFinancialLeaseWithPercentagesTest(double price, String downPaymentPercent,
                                                                  String leasePeriodYears, String leasePeriodMonths, String interest,
                                                                  String residualValuePercent, String expectedMonthlyPayment) {
        Helper.toggleVATIncluded(false);
        Find.clearAndFillField(PRICE_FIELD, String.valueOf(price));
    ...
    public void getLegalEntityFinancialLeaseWithEurosTest(double price, String downPaymentPercentage,
                                                            String leasePeriodYears, String leasePeriodMonths, String interest,
                                                            String residualPercentage, String expectedMonthlyPayment) {
        Helper.toggleVATIncluded(false);
        String downPaymentAmount = Helper.calculateValueFromPercentage(price, downPaymentPercentage);
    ...
    @Test(description = "Verify that User can switch from financial lease to operational lease.", priority = 12)
    public void switchLegalEntityFinancialLeaseToOperationalLeaseTest() {
        String originalPayment = Find.findAndGetText(MONTHLY_PAYMENT_SUM);
    ...
    public void getLegalEntityOperationalLeaseWithPercentagesTest(double price, String downPaymentPercent,
                                                                    String leasePeriodYears, String leasePeriodMonths, String interest,
                                                                    String residualValuePercent, String expectedMonthlyPayment) {
        Helper.toggleVATIncluded(false);
        Find.clearAndFillField(PRICE_FIELD, String.valueOf(price));
    ...
    public void getLegalEntityOperationalLeaseWithEurosTest(double price, String downPaymentPercentage,
                                                              String leasePeriodYears, String leasePeriodMonths, String interest,
                                                              String residualPercentage, String expectedMonthlyPayment) {
        Helper.toggleVATIncluded(false);
        String downPaymentAmount = Helper.calculateValueFromPercentage(price, downPaymentPercentage);
    ...
    @Test(description = "Verify that User can turn VAT included ON on legal entity operational lease.", priority = 15)
    public void toggleVATIncludedOnForLegalEntityOperationalLeaseTest() {
        String originalPayment = Find.findAndGetText(MONTHLY_PAYMENT_SUM);
    ...
    @Test(dataProvider = "operationalLeaseWithVAT", description = "Verify that monthly payment amount changes with " +
            "the values that are given to the calculator. Use percentage values for down payment and residual value inputs.", priority = 16)
    public void getLegalEntityOperationalLeaseWithPercentagesAndVATTest(double price, String downPaymentPercent,
                                                                  String leasePeriodYears, String leasePeriodMonths, String interest,
                                                                  String residualValuePercent, String expectedMonthlyPayment) {
        Helper.toggleVATIncluded(true);
        Find.clearAndFillField(PRICE_FIELD, String.valueOf(price));
    ...
    @Test(dataProvider = "operationalLeaseWithVAT", description = "Verify that monthly payment amount changes with " +
            "the values that are given to the calculator. Use sum amounts for down payment and residual value inputs.", priority = 17)
    public void getLegalEntityOperationalLeaseWithEurosAndVATTest(double price, String downPaymentPercentage,
                                                            String leasePeriodYears, String leasePeriodMonths, String interest,
                                                            String residualPercentage, String expectedMonthlyPayment) {
        Helper.toggleVATIncluded(true);
        String downPaymentAmount = Helper.calculateValueFromPercentage(price, downPaymentPercentage);
